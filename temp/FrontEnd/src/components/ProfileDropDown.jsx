...
const ProfileDropDown = (props) => {
    ...
    if (user) {
        navigation = [
            ...
            { title: "Log out", path: from, onClick: logoutUser },
        ];
    } else {
        navigation = [
            { title: "Profile", path: "/profile" },
    ...
    return (
        <div className={`relative ${props.class}`}>
            ...
            <ul
                className={`bg-white top-12 right-0 mt-3 space-y-3 lg:absolute lg:border lg:rounded-md lg:text-sm lg:w-48 lg:shadow-md lg:space-y-0 lg:mt-0 z-50 ${state ? "" : "lg:hidden"
                    }`}
            >
